...
def test_renderer_errors_when_gamestate_missing(monkeypatch):
    ...
    monkeypatch.setitem(sys.modules, "game.game_state",
                        types.ModuleType("game.game_state"))
    monkeypatch.setitem(sys.modules, "basicrl.game",
                        types.ModuleType("basicrl.game"))
    monkeypatch.setitem(
        sys.modules, "basicrl.game.game_state", types.ModuleType(
